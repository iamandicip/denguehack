...
class TweetManager:
	...
	def getTweets(tweetCriteria, receiveBuffer = None, bufferLength = 100):
		...
		while active:
			...
			for tweetHTML in tweets:
				...
				with open('tweets_html.html', 'a') as f:
					f.write(str(tweetHTML))
	...
	def getJsonReponse(tweetCriteria, refreshCursor, cookieJar):
		...
		if(hasattr(tweetCriteria, 'location')):
			urlGetData += ' near:"' + tweetCriteria.location + '"'

		if(hasattr(tweetCriteria, 'radius')):
			urlGetData += ' within:' + tweetCriteria.radius
